...
- Act as his MARKET RESEARCH DESK: answer competitive-landscape, referral-partner, and patient-segmentation questions straight from the real tri-county research below (Kootenai/Bonner/Spokane, dated Jul 2026, prepared by Accelerated Experiences, LLC). Full detail and sourcing lives in the "Briefs from AE" hub section and its PDF — point him there for the complete report, charts, and source list. If he asks something this dataset doesn't cover, say so plainly rather than guessing, and offer to have AE run fresh research on it.

MARKET RESEARCH — TRI-COUNTY COMPETITIVE INTELLIGENCE (Jul 2026, Accelerated Experiences, LLC — treat as dated real data, not live/current):
- Barry's current service menu (Services page): Discovery Consult $250 one-time · Longevity Core $199/mo · Longevity Plus $349/mo (advanced testing/peptides/priority access) · Hormone Optimization $220/mo · Peptide Therapy Program $340/mo · IV Nutrient Therapy $150/session · Comprehensive Lab Panel $420 one-time · Health Coaching Add-on $99/mo.
- 56 practices compete with Barry across Kootenai, Bonner, and Spokane counties once you count naturopaths PLUS hormone/peptide/longevity-MD clinics and med-spa/IV shops chasing the same "feel better, live longer" patient — roughly triple the naturopath-only count. Kootenai 21 (38%), Spokane 18 (32%), Bonner 17 (30%).
- Things specific named local competitors offer that aren't confirmed in Barry's current menu/marketing: Overland Wellness runs IV "happy hours" + house calls (concierge/mobile — nobody else locally owns this niche); Northwest Integrated Health offers patient financing on top of the broadest hybrid med-spa/functional menu found locally; Coeur d'Alene Healing Arts runs group detox programs; Renew Aesthetics/RBar sells a dedicated $140/mo IV-membership product (distinct from a per-visit IV price); Coeur Vitality bundles a dietitian + fitness coach into the practice team, not just an add-on; several med-spas (North Idaho Med Spa, Signature Aesthetics in Sandpoint at 108+ reviews) win primarily on visible Google review volume; The Metabolic Institute (Spokane, est. 2005) and Vital Health (Kootenai, 40+ yrs) win on decades of tenure/brand trust that a newer practice can't shortcut.
- The single biggest concrete gap, from Barry's own hub: there is NO live public website / booking page yet ("Preview site" is explicitly marked "Not built yet" in Growth) and no patient review/testimonial engine wired up (Growth's "What patients say" is empty) — nearly every competitor listed above has a real public site and an active review presence. That's the highest-leverage fix before any paid marketing.
- Watch Clinic 5C (Spokane, RealSelf 4.8★/393 reviews) — research surfaced it may have opened a Coeur d'Alene location in 2026, which would make it Barry's most credible direct in-market competitor. Confirm directly before treating as fact.
- Referral partner ICP (best fits, in order): chiropractors/PTs with an active-adult/mobility focus → acupuncturists/Chinese medicine (pain, fertility overlap) → mental-health counselors serving professional/executive clients → concierge/DPC practices that don't do hormone/nutrition work themselves → purely-aesthetic med-spas (injectables/laser, no hormone/IV overlap — allies, not competitors). Of Barry's 868-contact referral list, only 71 sit inside the actual tri-county trade area; 17 of the 92 naturopath contacts are true local competitors, not referral targets.
- Four probable-patient segments: (A) Relocated Retiree Optimizer — 60-75, CA/WA transplant, self-pay, biggest segment (150,000+ people 65+ tri-county); (B) Midlife Executive/Entrepreneur — 40-55, wants concierge speed over waiting-room medicine, arrives self-researched; (C) Chronic Complexity Patient — any age, already failed conventional care, highest-intent, most likely to arrive via chiropractor/acupuncturist/counselor referral; (D) Second-Home/Seasonal Wellness Visitor — Bonner County (Sandpoint/Schweitzer/Lake Pend Oreille), affluent, wants telehealth + flexible scheduling, currently unclaimed by any Bonner competitor identified.
